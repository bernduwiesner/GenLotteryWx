...
class MainFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.SetFont(wx.Font(pointSize=C.FONT_POINT_SIZE,
    ...
    def make_menu_bar(self):
        ...
        exit_menu_item = wx.MenuItem(parentMenu=file_menu,
                                     id=C.ID_MENU_EXIT,
                                     text=u"E&xit",
                                     helpString=wx.EmptyString,
                                     kind=wx.ITEM_NORMAL)
        file_menu.Append(menuItem=exit_menu_item)
        main_menu_bar.Append(menu=file_menu,
                             title=u"&File")

        help_menu = wx.Menu()
        about_menu_item = wx.MenuItem(parentMenu=help_menu,
                                      id=C.ID_MENU_ABOUT,
                                      text=u"&About",
                                      helpString=wx.EmptyString,
                                      kind=wx.ITEM_NORMAL)
        help_menu.Append(menuItem=about_menu_item)
        main_menu_bar.Append(menu=help_menu,
                             title=u"&Help")
    ...
    def make_main_controls(self):
        ...
        choice_text = wx.StaticText(self,
                                    id=wx.ID_ANY,
        ...
        lines_control = intctrl.IntCtrl(parent=self,
        ...
        grid.Add(lines_control,
                 pos=wx.GBPosition(row=2, col=2),
                 span=wx.GBSpan(rowspan=1, colspan=1),
                 flag=wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                 border=5)

        radio_box = wx.RadioBox(self,
                                id=wx.ID_ANY,
                                label=u"Options",
                                pos=wx.DefaultPosition,
                                size=wx.DefaultSize,
        ...
        ok_button = wx.Button(parent=self,
                              id=wx.ID_OK)
        button_sizer.AddButton(button=ok_button)
        cancel_button = wx.Button(parent=self,
                                  id=wx.ID_CANCEL)
        button_sizer.AddButton(button=cancel_button)
        button_sizer.Realize()
        grid.Add(button_sizer,
        ...
        radio_box.Bind(event=wx.EVT_RADIOBOX,
                       handler=self.on_radiobox)
    ...
    def make_status_bar(self):
        ...
        main_status_bar = self.CreateStatusBar(number=1,
                                               style=__style__,
                                               id=wx.ID_ANY,
